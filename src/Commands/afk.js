...
module.exports = {
  ...
  onRequest: async function (client, message, args, guild) {
    ...
    message.channel.send(`${client.emoji(wonxenveri.Others.CheckTick)}  ${message.member} adlı üye ${tarih}  __**${sebep}**__ sebebi ile AFK moduna girdi!`).then(x => x.delete({timeout: 10000}));
